...
EXPERIMENT_DETAILS = {'FEATURE_EXP': 'mel',
                      ...
                      'ITERATION_EPOCH': 1,
                      'SUB_DIR': 'final/IDL/pitch_tmp10_random',
                      'temperature': 10,
                      'EXP_RUNTHROUGH': 1,
                      'BN_per_epoch_train': 4300,
                      'BN_dev': 500,
                      'SAVE_MODEL_FROM':1,
                      'random_speaker': True,
                      'Augmentation': True,
...
single_augmentation = True #false for random augmentation, true for single augmentation list below
#TM
use_time_mask = False   #fixed length masking, if random, use time mask in specaug
time_mask_size = 20
...
AUG_DATA_path='/home/../data/jinhan/Dataset/librispeech/LibriSpeech360/audio_feats/feats_DepAudioNet_pitch/mel_svn_exp'
...
WORKSPACE_MAIN_DIR ='/home/../data/jinhan/Dataset/cn-celeb/cn-celeb/CN-Celeb/audio_feats/feats_DepAudioNet'
#NOISE_10dB_path='/home/jinhan/Dataset/cn-celeb/cn-celeb/CN-Celeb//audio_feats/feats_DepAudioNet_noise_10dB/mel_svn_exp'
#NOISE_20dB_path='/home/jinhan/Dataset/librispeech/LibriSpeech360/audio_feats/feats_DepAudioNet_noise_20dB/mel_svn_exp'
AUG_DATA_path='/home/../data/jinhan/Dataset/cn-celeb/cn-celeb/CN-Celeb/audio_feats/feats_DepAudioNet_vtlp/mel_svn_exp'
WORKSPACE_FILES_DIR = '/home/jinhan/DepAudioNet_reproduction'
