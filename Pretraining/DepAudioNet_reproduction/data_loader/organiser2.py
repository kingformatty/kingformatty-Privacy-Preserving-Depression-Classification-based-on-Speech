...
def run_train(config, logger, checkpoint, features_dir, data_saver):
    ...
    #convert the first entry in each element into floay, otherwise, wrong speaker order
    #but doesn't affect pre-training, only mismatch between feature and label, where label is not
