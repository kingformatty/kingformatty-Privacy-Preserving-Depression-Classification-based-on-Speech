...
class GenerateData:
    def __init__(self, train_labels, dev_labels, train_feat,train_feat_aug, dev_feat,
                 dev_feat_aug, train_loc, dev_loc, train_indices, dev_indices, logger, config,
    ...
    def generate_development_data(self, epoch):
        ...
        for i in range(self.BN_dev):
            ...
            if self.config.EXPERIMENT_DETAILS['random_speaker']:
                ...
                chosen_folder_indices = np.random.choice(len(self.dev_loc),replace = False, size = self.batch_size)
                for index in chosen_folder_indices:
            ...
            locs_array = 0
            yield batch_data, batch_labels, batch_folders, locs_array, batch_data_aug
