...
def evaluate(model, generator, data_type, class_weights, comp_res, comp_res_seg, class_num,
    ...
    complete_results_seg, _ = prediction_and_accuracy(outputs,targets, True, class_num, comp_res_seg,0,0, f_score_average_seg)
...
def test():
    ...
    for exp_num in range(exp_runthrough):
        ...
        if config.EXPERIMENT_DETAILS['SPLIT_BY_GENDER']:
            ...
            p_r_f_score_list_seg.append(scores_seg[3:10])
    # tn_fp_fn_tp
    print('*'*50)
