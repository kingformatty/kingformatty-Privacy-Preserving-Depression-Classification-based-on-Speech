...
from data_loader import data_gen_all as data_gen
...
def run_train(config, logger, checkpoint, features_dir, data_saver):
    ...
    #compensate for index issue when augmentation 

    train_indices[:-30 ] = train_indices[:-30] - 30
    train_indices[-30:] = train_indices[-30:] + 189
    dev_indices = dev_indices - 30
