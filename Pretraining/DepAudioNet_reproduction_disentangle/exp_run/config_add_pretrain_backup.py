...
EXPERIMENT_DETAILS = {'FEATURE_EXP': 'mel',
                      ...
                      'ITERATION_EPOCH': 1,
                      'SUB_DIR': '/home/jinhan/Dataset/converge_merged_audio_feats/feats_DepAudioNet/mel_svn_exp/Baseline',
                      'EXP_RUNTHROUGH':5, 
                      'hidden_size': 128,
                      'bidirectional': False,
                      'stat_pool': False,
...
Pretrain = False
Resume_model_from = '/home/jinhan/Dataset/librispeech/LibriSpeech360/audio_feats/feats_DepAudioNet/mel_svn_exp/exp_BN_20/Speconly_tmp10_random/model/1/md_85_epochs.pth'
#Resume_model_from = '/home/jinhan/Dataset/librispeech/LibriSpeech/audio_feats/feats_DepAudioNet/mel_svn_exp/backup_sigmoid/IDL_pretrain_LR1e-3_distinct_speaker_tmp0.1_norm/model/1/md_100_epochs.pth'
freeze = False
data_saver =  False
batch_norm = False
...
DATASET ='/home/vijaysumaravi/Documents/database/daic-woz-old/'+data_path
WORKSPACE_MAIN_DIR ='/home/vijaysumaravi/Documents/database/daic-woz-old/audio_feats/'+ workspace_path
WORKSPACE_FILES_DIR = '/home/jinhan/DepAudioNet_reproduction'
TRAIN_SPLIT_PATH ='/home/vijaysumaravi/Documents/database/daic-woz-old/'+label_path+'/train_split_Depression_AVEC2017.csv'
DEV_SPLIT_PATH ='/home/vijaysumaravi/Documents/database/daic-woz-old/'+label_path+'/dev_split_Depression_AVEC2017.csv' 
TEST_SPLIT_PATH ='/home/vijaysumaravi/Documents/database/daic-woz-old/'+label_path+'/full_test_split.csv'
